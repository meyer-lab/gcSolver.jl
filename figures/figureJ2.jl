...
function figureJ2()
    ...
    p9 = doseResPlot2("R38Q/H16N", "Treg", "4/19/2019", fitVec)
    p10 = doseResPlot2("R38Q/H16N", "Thelper", "4/19/2019", fitVec)
    p11 = doseResPlot2("R38Q/H16N", "NK", "5/02/2019", fitVec)
    p12 = doseResPlot2("R38Q/H16N", "CD8", "3/19/2019", fitVec)
    """
    p13 = doseResPlot2("WT N-term", "Treg", "4/19/2019", fitVec)
    p14 = doseResPlot2("WT N-term", "Thelper", "4/19/2019", fitVec)
    p15 = doseResPlot2("WT N-term", "NK", "5/2/2019", fitVec)
    p16 = doseResPlot2("WT N-term", "CD8", "5/2/2019", fitVec)
    p17 = doseResPlot2("H16N N-term", "Treg", "4/19/2019", fitVec)
    p18 = doseResPlot2("H16N N-term", "Thelper", "4/19/2019", fitVec)
    p19 = doseResPlot2("H16N N-term", "NK", "5/2/2019", fitVec)
    p20 = doseResPlot2("H16N N-term", "CD8", "5/2/2019", fitVec)
    p21 = doseResPlot2("R38Q N-term", "Treg", "4/19/2019", fitVec)
    p22 = doseResPlot2("R38Q N-term", "Thelper", "4/19/2019", fitVec)
    p23 = doseResPlot2("R38Q N-term", "NK", "5/2/2019", fitVec)
    p24 = doseResPlot2("R38Q N-term", "CD8", "5/2/2019", fitVec)
