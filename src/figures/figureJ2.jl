...
function figureJ2()
    ...
    p5 = doseResPlot2("IL15", "Treg", "2019-03-19", fitVec)
    p6 = doseResPlot2("IL15", "Thelper", "2019-03-19", fitVec)
    p7 = doseResPlot2("IL15", "NK", "2019-03-15", fitVec)
    p8 = doseResPlot2("IL15", "CD8", "2019-03-15", fitVec)
    p9 = doseResPlot2("R38Q/H16N", "Treg", "2019-04-19", fitVec)
    ...
    p16 = doseResPlot2("WT N-term", "CD8", "2019-05-02", fitVec)
    p17 = doseResPlot2("H16N N-term", "Treg", "2019-04-19", fitVec)
    p18 = doseResPlot2("H16N N-term", "Thelper", "2019-04-19", fitVec)
    p19 = doseResPlot2("H16N N-term", "NK", "2019-05-02", fitVec)
    p20 = doseResPlot2("H16N N-term", "CD8", "2019-05-02", fitVec)
    p21 = doseResPlot2("R38Q N-term", "Treg", "2019-04-19", fitVec)
    p22 = doseResPlot2("R38Q N-term", "Thelper", "2019-04-19", fitVec)
