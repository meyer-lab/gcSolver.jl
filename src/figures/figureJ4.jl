...
function figureJ4()
    ...
    draw(SVG("figureJ4.svg", 2500px, 3200px), gridstack([p1 p2 p3; p1rec p2rec p3rec; p4 p5 p6; p4rec p5rec p6rec; p7 p8 p9; p7rec p8rec p9rec; p10 p11 p12; p10rec p11rec p12rec]))
end
